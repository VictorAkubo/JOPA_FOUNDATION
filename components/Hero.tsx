  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center z-10">
        ...
        {/* Content focused on the spirit of giving */}
        <p className="hero-fade text-lg md:text-xl text-slate-400 font-light max-w-2xl mx-auto leading-relaxed mb-12">
          JOPA Foundation is built on the belief that a small act of kindness can change a family's story. Through the simple gift of food, we extend our hearts to our community, ensuring no one walks their journey alone.
        </p>

        {/* Action buttons that feel like an invitation */}
        <div className="hero-fade flex flex-col sm:flex-row items-center justify-center gap-6">
          <button className="w-full sm:w-auto px-10 py-4 bg-transparent border border-white/20 hover:border-orange-500/50 text-white font-medium rounded-full transition-all duration-700 tracking-wide">
            Our Shared Mission
          </button>
      ...
      <div className="absolute bottom-10 left-0 w-full text-center px-6 opacity-40">
        <p className="text-[10px] uppercase tracking-[0.6em] text-slate-500 font-bold">
          JOPA Philanthropy • Lagos, Nigeria
        </p>
      </div>
    </section>
  );
